...
# - `irreversibility`: Determines the irreversibility criterion; in this case, set to "miehe." We consider anisotropic (spectral) degradation  and irreversibility as proposed by Miehe.
...
# conditions dynamically at each time step, enabling quasi-static analysis 
