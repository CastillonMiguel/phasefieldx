r"""
.. _ref_ppf_energy_controlled_three_point_var:

Three Point: (Variational)
--------------------------
...
Data = Input(E=20.8,
             ...
             results_folder_name="results_three_point_var")
...
###############################################################################
# Plot: Force vs Displacement: Model equivalent Gc
# ------------------------------------------------
alpha = 1/np.sqrt(1+c1*S.dof_files["lambda.dof"]["lambda"]/Data.Gc)

fig, ax_reaction = plt.subplots()

ax_reaction.plot(displacement_half*alpha, force_half*alpha, 'k-')
