...
.geo File: Rectangle
^^^^^^^^^^^^^^^^^^^^
This example demonstrates the procedure for generating a structured mesh for rectangle.
...
.. include::  ../../../../examples/GmshGeoFiles/9104_Structured/file.geo
   :literal:
