...
def test_phase_field_simulation_ener_non_variational():
    """
    Test phase-field fracrture energy non-variational solver and compare results with theoretical values.
    """
    ...
    Data = Input(E=210.0,   # young modulus
                    ...
                    results_folder_name="results_test_ener_non_variational")
    ...
    reaction_simulation = abs(S.reaction_files["bottom.reaction"]["Ry"])
